...
# movie-box: educational CLI movie downloader by parthmax

**movie-box by Saksham Pathak, aka parthmax / parthmax2**  
An educational Python CLI movie downloader and API client for learning async
networking, command line tooling, structured data models, subtitle handling,
and resumable media workflows.
...
!!! warning "Educational use only"
    movie-box is provided for educational purposes only. Use it only with
    content you are legally allowed to access, stream, inspect, or download.
    The project does not host media files, does not bypass access controls, and
    is not affiliated with or endorsed by MovieBox or any related provider.

## Keywords

movie-box, movie downloader, CLI movie downloader, Python movie downloader,
subtitle downloader, parthmax, parthmax2, Saksham Pathak.
