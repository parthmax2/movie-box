...
from movie_box.v3._bases import BaseContentProviderAndHelper
...
from movie_box.v3.exceptions import (
        ...
        if self._subject_type is not SubjectType.ALL:
            ...
            for item in contents["items"]:
                if item["subjectType"] == self._subject_type.value:
                    # https://github.com/parthmax2/movie-box/issues/55
...
class DownloadableVideoFilesDetail(BaseContentProviderAndHelper):
    ...
    def _create_params(self, subject_id: str) -> dict:
        ...
        if isinstance(resolution, ResolutionType):
