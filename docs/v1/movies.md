...
=== "Async"
    ...
    3. Output: `#!python  <class 'movie_box.v1.models.SearchResultsModel'>`. Access search result items from `#!python search_results.items`
...
=== "Async"
    ...
    2. `<class 'movie_box.v1.extractor.models.json.ItemJsonDetailsModel'>`
...
=== "Async"
    ...
    2. Output : `#!python  <class 'movie_box.v1.models.DownloadableFilesMetadata'>`
