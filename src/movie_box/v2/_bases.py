...
from movie_box.v2.exceptions import InvalidDetailPathError
from movie_box.v2.helpers import get_absolute_url, validate_detail_path
from movie_box.v2.models import SpecificItemDetailsModel
