...
=== "Async"
    ...
    2. `#!python <class 'movie_box.v1.models.SearchResultsModel'>` access individual search result items from `#!python search_results.items`
...
=== "Async"
    ...
    2. Output: `#!python <class 'movie_box.v1.extractor.models.json.ItemJsonDetailsModel'>`
...
=== "Async"
    ...
    1. Output: `#!python <class 'movie_box.v1.extractor.models.json.ItemJsonDetailsModel'>`
...
=== "Async"
    ...
    1. Output: `#!python <class 'movie_box.v1.models.DownloadableFilesMetadata'>`
