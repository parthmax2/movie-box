...
!!! question "Why TV series lack **Auto**magic"
    This is a deliberate choice by the [developers](https://github.com/parthmax2). The current focus is more on implementing new features rather than adding miscellaneous ones. It may be implemented in the future, or you could **[submit a PR](https://github.com/parthmax2/movie-box/pulls)**.
