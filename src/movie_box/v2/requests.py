...
import movie_box.v1.requests
from movie_box.v2.constants import DOWNLOAD_REQUEST_HEADERS
...
class Session(movie_box.v1.requests.Session):
    ...
    @deprecated("This method is only available to to V1 of movie_box.requests")
    async def _fetch_app_info(self) -> None:
        raise NotImplementedError(
            "This functionality is only available to V1 of movie_box.requests"
        )
