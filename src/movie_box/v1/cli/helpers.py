...
from movie_box import __repo__
from movie_box.v1 import logger
...
from movie_box.v1.core import Search, Session
...
async def perform_search_and_get_item(
    ...
    over_prefix = "over " if search_results.pager.hasMore else ""
    logger.info(
        f"Query '{title}' yielded {over_prefix}"
    ...
    if yes:
        ...
        for pos, item in enumerate(items, start=1):
            ...
            if click.confirm(
                ...
                f"{item_subject_type}{item.title}"
