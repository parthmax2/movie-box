...
from movie_box.v1.constants import MIRROR_HOSTS, SubjectType
from movie_box.v1.core import (
    Homepage,
    MovieDetails,
    PopularSearch,
    TVSeriesDetails,
)
from movie_box.v1.extractor import JsonDetailsExtractor
from movie_box.v1.helpers import get_event_loop
from movie_box.v1.requests import Session
...
def item_details_command(
    ...
    supported_subject_types = " or ".join(
